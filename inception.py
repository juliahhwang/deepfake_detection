...
checkpoint = tf.keras.callbacks.ModelCheckpoint('best_inceptionresnet.keras', monitor='val_loss', save_best_only=True)
...
best_model = tf.keras.models.load_model('best_inceptionresnet.keras')
...
print('Classification Report: \n', classification_report(y_labels, y_pred, zero_division=0))
